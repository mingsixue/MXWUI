...
<img src="../imgs/components/Nav.PNG" alt="Nav" width="280" />
<img src="../imgs/components/Nav2.PNG" alt="Nav 2" width="280" />
...
```html
<mx-nav titleImg="https://cdn.mingsixue.com/xcx/MXWUI/mxwui.png" />
```
...
```html
<mx-nav iconImg="https://cdn.mingsixue.com/xcx/MXWUI/hot.png" />
```
...
- 自定义图片
```html
<mx-nav secondIconImg="https://cdn.mingsixue.com/xcx/MXWUI/set.png" bind:nav_second_icon_tap="secondIconTap" />
```

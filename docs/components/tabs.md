...
<img src="../imgs/components/Tabs.PNG" alt="Tabs" width="280" />
<img src="../imgs/components/Tabs2.PNG" alt="Tabs 2" width="280" />
<img src="../imgs/components/Tabs3.PNG" alt="Tabs 3" width="280" />
<img src="../imgs/components/Tabs4.PNG" alt="Tabs 4" width="280" />
...
data: {
    options: [
        {text: '选项名', value: '选项值', iconUrl: 'https://cdn.mingsixue.com/xcx/MXWUI/hot.png', iconSize: 28},
    ],
},
```

...
<img src="../imgs/components/Empty.PNG" alt="Empty" width="280" />
<img src="../imgs/components/Empty2.PNG" alt="Empty 2" width="280" />
...
- 自定义图片
```html
<mx-empty iconUrl="https://cdn.mingsixue.com/xcx/MXWUI/remind2.png" iconSize="240" />
```

...
> 说明：早期规划中的 TimeRange 时间段组件已合并为本组件，请直接使用 `mx-datetime-range`。

## 示例图

<img src="../imgs/components/DatetimeRange.PNG" alt="DatetimeRange" width="280" />
<img src="../imgs/components/DatetimeRange2.PNG" alt="DatetimeRange 2" width="280" />

...
<img src="../imgs/components/Menu.PNG" alt="Menu" width="280" />
<img src="../imgs/components/Menu2.PNG" alt="Menu 2" width="280" />
    ...
    options: [
        {
            ...
            iconSelectUrl: 'https://cdn.mingsixue.com/xcx/MXWUI/set.png',
        },
    ]
}
```
